...
在 Apple Watch 上离线玩五子棋。支持本机双人轮流对弈和三个难度的 AI 对战。

当前准备版本：**0.1.0 预览版**。项目尚未发布到 GitHub、TestFlight 或 App Store。
...
AI 使用本地、有时间和节点预算的搜索，包含候选筛选与战术搜索，不保证找到所有必胜手；尚无标准对战胜率或 Elo。最新版本尚待真机耗时、耗电和完整体验验收。GitHub 源码不能直接作为已签名的手表安装包。
